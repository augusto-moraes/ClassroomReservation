...
export default function Salle({salle = 'TDX', heures, duration, desc = salle + ' est une salle incroyable !'}) {
    ...
    // Const
    const hours = heures;
    const duree = duration;

    // Functions

  return (
    <div style={{display: "flex", alignItems: "center", justifyContent: "center"}}>
      <Card style= {{paddingLeft: 25, paddingBottom:25, padding:20, margin: "10px", width: '750px', borderRadius: "5px", backgroundColor: 'white', boxShadow: '2px 2px 0px #D7D7D7', whiteSpace: 'nowrap', overflowX: 'scroll'}}>
        <h1>Salle {salle}</h1>
